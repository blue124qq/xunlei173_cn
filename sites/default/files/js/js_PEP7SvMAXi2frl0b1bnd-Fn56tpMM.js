...
var browser_version_check = (function () {
    ...
    if (browserVersion() > -1 && browserVersion() < 8) {
        var browserAlert = '<div class="alert"><div><p><strong>Your browser is out of date!</strong> You’re using a outdated browser. For the best experience, please update <a href="http://browser-update.org/update.html#3">your browser</a>.</p></div></div>';
